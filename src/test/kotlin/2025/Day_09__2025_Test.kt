...
class Day09Test {
    ...
    fun example_part1() {
        ...
        assertEquals(0L, Day09.part1(exampleInput1))
    }

    @Test
    fun example_part2() {
        // TODO: adjust expected value once known
        assertEquals(0L, Day09.part2(exampleInput2))
    }

    @Test
    fun real_part1() {
        // TODO: adjust expected value once known
        assertEquals(0L, Day09.part1(realInput))
    }

    @Test
    fun real_part2() {
        // TODO: adjust expected value once known
        assertEquals(0L, Day09.part2(realInput))
    }
}
